...
import { Maybe, ProductAttributeTypeContainer, ProductContentContainer, ProductDetail, ProductDocumentContainer, ProductImageContainer, ProductInventoryFulfillment, ProductRelatedProductContainer, ProductRestrictionGroupContainer, ProductSeasonal, ProductSpecificationContainer, ProductUnitOfMeasureContainer, ProductVariantTraitContainer, ProductWarehouseContainer, Scalars } from "@/gql/graphql";
