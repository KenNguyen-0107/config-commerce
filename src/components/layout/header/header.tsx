		...
		<header className="sticky top-0 z-50 w-full bg-white">
			...
			<div className="container flex h-14 items-center justify-between lg:h-20">
				...
				<div className="hidden lg:flex items-center space-x-2">
					...
					<SmartLink href="/" className="text-2xl font-bold text-blue">
						0800 408 2234
					</SmartLink>
				</div>
				...
				>
					<Image src="/images/logo.jpg" alt="Jacksons Fencing" width={355} height={36} priority />
				</SmartLink>
				...
				<div className="flex items-center space-x-3 lg:space-x-6">
					<div className="hidden lg:block">
						...
						<div className="relative group z-[1]">
							<SmartLink href="/account" className="font-medium text-blue">
								MY ACCOUNT
							</SmartLink>
					...
					<SmartLink href="/contact" className="flex items-center lg:hidden">
						<Phone className="h-6 w-6 text-blue" />
					</SmartLink>
					{/* <DarkModeToggle /> */}
					<MiniCart />
