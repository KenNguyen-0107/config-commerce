			...
			<div className="grid grid-cols-5 gap-8">
				<div>
					...
					<nav className="space-y-2">
						<SmartLink href="/contact" className="footer-link block">
							Contact us
						</SmartLink>
						<SmartLink href="/jobs" className="footer-link block">
							Job Vacancies
						</SmartLink>
						<SmartLink href="/policies" className="footer-link block">
							Policies
						</SmartLink>
						<SmartLink href="/privacy" className="footer-link block">
							Privacy
						</SmartLink>
						<SmartLink href="/legal" className="footer-link block">
							Legal
						</SmartLink>
					</nav>
				</div>
				...
				<div>
					...
					<nav className="space-y-2">
						<SmartLink href="/gate-automatic" className="footer-link block">
							Gate automatic
						</SmartLink>
						<SmartLink href="/approved-installer" className="footer-link block">
							Approved installer service
						</SmartLink>
						<SmartLink href="/installation" className="footer-link block">
							Installation & Advice
						</SmartLink>
					</nav>
				</div>
				...
				<div>
					...
					<nav className="space-y-2">
						<SmartLink href="/quotes" className="footer-link block">
							quotes
						</SmartLink>
						<SmartLink href="/fencing" className="footer-link block">
							Fencing
						</SmartLink>
						<SmartLink href="/gates" className="footer-link block">
							Gates
						</SmartLink>
						<SmartLink href="/landscape" className="footer-link block">
				...
				<div>
					...
					<nav className="space-y-2">
						<SmartLink href="/calculator" className="footer-link block">
							Fence Calculator
						</SmartLink>
						<SmartLink href="/builder" className="footer-link block">
							Decking Builder
						</SmartLink>
						<SmartLink href="/gate-builder" className="footer-link block">
							Gate Builder
						</SmartLink>
						<SmartLink href="/faqs" className="footer-link block">
							FAQs
						</SmartLink>
						<SmartLink href="/delivery" className="footer-link block">
							Delivery
						</SmartLink>
						<SmartLink href="/edit" className="footer-link block">
							The edit
						</SmartLink>
					</nav>
				</div>
				...
				<div>
					...
					<div className="flex space-x-3">
						...
						<SmartLink href="https://facebook.com" className="hover:opacity-80">
							<svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
								<path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
							</svg>
						</SmartLink>
						<SmartLink href="https://twitter.com" className="hover:opacity-80">
							<svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
								<path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
							</svg>
						</SmartLink>
						<SmartLink href="https://linkedin.com" className="hover:opacity-80">
							<svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
								<path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
							</svg>
						</SmartLink>
						<SmartLink href="https://youtube.com" className="hover:opacity-80">
							<svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
					...
					<div className="mt-6">
						<SmartLink
							href="/brochure"
							className="bg-[#283270] text-white px-6 py-3 inline-block font-semibold hover:bg-[#283270]/90 transition-colors"
						>
							REQUEST A BROCHURE
						</SmartLink>
					</div>
					<div className="mt-6">
						<h3 className="text-[#283270] font-semibold mb-2">
							NEED HELP? CALL US
						</h3>
						<SmartLink
							href="tel:08004082234"
							className="text-[#283270] text-2xl font-bold"
						>
							0800 408 2234
						</SmartLink>
					</div>
			...
			<div className="mt-12 pt-8 border-t border-gray-200">
				<div className="flex justify-between items-center">
					...
					<div className="flex items-center space-x-4">
						...
						<svg className="h-8" viewBox="0 0 1000.046 323.653" fill="#1A1F71">
