...
const QuantityControl = ({ onChangeQuantity, quantity, showControl = true }: {
	...
	return (
		<div className="flex items-center gap-2">
			<button onClick={() => { onChangeQuantity(Math.max(1, --quantity)); setResetInputKey(--quantity) }}>
			...
			<button onClick={() => { onChangeQuantity(++quantity); setResetInputKey(++quantity) }}>
