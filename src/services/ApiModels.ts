...
export enum CurrencyPositioningType {
	Left = "Left",
	Right = "Right",
}
...
export enum BadgeTypeValues {
	Image = "Image",
	Text = "Text",
}

export enum BadgeImagePlacementValues {
	None = "None",
	TopLeft = "Top Left",
...
export interface RealTimeCartInventoryModel extends BaseModel {
	warehouseAvailabilities: { [key: string]: AvailabilityDto } | null;
}
...
export interface WishListLineModel extends BaseModel {
	...
	qtyPerBaseUnitOfMeasure: number;
	quoteRequired: boolean;
	replacementProduct: ProductDto | null;
	selectedUnitOfMeasure: string;
	shortDescription: string;
	smallImagePath: string;
	sortOrder: number;
...
export interface WishListModel extends BaseModel {
	...
	wishListTags?: WishListTagModel[] | null;
}
...
export interface WishListTagCollectionModel extends BaseModel {
	pagination: PaginationModel | null;
	wishListTags: WishListTagModel[] | null;
}

export interface WishListTagModel extends BaseModel {
	id: string;
	tag: string;
}
