...
export default async function ThanksYourOrder() {
  const sdk = getSdk();
  const data = getFirstIfExists((await sdk.getOrderConfirmationPageContent())?.OrderConfirmationPage?.items) as ICheckoutAddAddress
