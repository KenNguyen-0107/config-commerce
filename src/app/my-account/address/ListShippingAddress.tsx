...
const ListShippingAddress = () => {
	...
	const shipping = ["Niteco", "London, Greater London 10000", "anh.nguyen12@niteco.se"];
				...
				<div key={index} className="border-b border-gray-200 pb-6">
					<div className="flex justify-between">
						<div className="text-tertiary space-y-1">
							{shipping.map((item, index) => (
								<p key={index} className="font-lora text-sm lg:text-base font-medium">
									{item}
								</p>
							))}
						</div>
						<div className="flex flex-col items-end gap-2">
							...
							<Button className="text-tertiary md:hidden" buttonLabel="More options">
