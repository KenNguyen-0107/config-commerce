...
export const API_BASE_URL = process.env.API_BASE_URL || "https://jacksonsfencing-configcommerce-d-cl.niteco.dev"
...
export const API_ENDPOINTS = {
  // Website info
  countrySetting: "/api/v1/websites/current/countries?expand=state",
  ...
  relatedShipTo: (billToId: string, shipToId?: string) => `/api/v1/billtos/${billToId}/shiptos/${shipToId || ""}?expand=validation`,
  getAllShipTos: "/api/v1/billtos/current/shiptos?filter=&page=1&expand=validation&exclude=showAll%2ConeTime%2CbillTo&pageSize=8",
  //product pricing
...
export const DEFAULT_QUERY_PARAMS = {
  ...
  getCurrentCart: {
    expand: "shipping,validation,cartLines,restrictions,carriers,paymentOptions,costCodes,hiddenproducts,tax",
