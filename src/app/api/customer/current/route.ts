...
export async function PATCH(request: NextRequest) {
  try {
    // Get the request body with the defined type
    const requestBody: UpdateSessionRequest = await request.json()
    const url = `${API_BASE_URL}${API_ENDPOINTS.patchCustomerInfo}`
