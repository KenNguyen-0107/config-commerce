...
import type { ContentLinkWithLocale, ContentLink, InlineContentLinkWithLocale } from "@packages/optimizely-graph"

// Export reused content types
export type ContentType = string[]
export type {
    /**
     * @deprecated  Use the export from `@packages/optimizely-graph` directly
     */
    ContentLink,
    /**
     * @deprecated  Use the export from `@packages/optimizely-graph` directly
